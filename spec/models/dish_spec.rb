...
RSpec.describe Dish, type: :model do
  ...
  describe '#valid?' do
    ...
    it 'must be invalid without a name' do
      dish = Dish.new(description: 'Uma deliciosa refeição', calories: 100, restaurant: restaurant)
  ...
  describe 'calories validation' do
    it 'should have a non-negative number of calories' do
      dish = Dish.new(name: 'Pizza', description: 'Uma deliciosa refeição', calories: -100, restaurant: restaurant)
