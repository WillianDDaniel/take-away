...
describe 'Edit Dish Portion Page' do
  it 'if user is not logged in, should redirect to the signin page' do
    visit edit_dish_portion_path(1, 1)
  ...
  it 'if user not have a portion, should redirect to dashboard' do
    ...
    visit edit_dish_portion_path(dish.id, 1)
  ...
  it 'if the portion not pertence to user, should redirect to dashboard' do
    ...
    dish = Dish.create!(
      name: 'Prato Teste2', description: 'Descricão do prato teste2',
      calories: 10, restaurant: second_restaurant
    )

    login_as(second_user)

    visit edit_dish_portion_path(dish.id, portion.id)
  ...
  it 'should see a form to edit a portion' do
    ...
    expect(page).to have_content('Editar porção de Prato Teste')
  ...
  it 'should not to be visible to staff users' do
    ...
    portion = Portion.create!(description: 'Descricão da porção teste', price: 10, portionable: dish)
